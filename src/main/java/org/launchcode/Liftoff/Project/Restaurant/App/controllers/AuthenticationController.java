...
import org.launchcode.Liftoff.Project.Restaurant.App.models.dto.LoginFormDTO;
import org.launchcode.Liftoff.Project.Restaurant.App.models.dto.RegisterFormDTO;
...
public class AuthenticationController {
    ...
    public String processLoginForm(@ModelAttribute @Valid LoginFormDTO loginFormDTO,
        ...
        if (theUser == null) {
            errors.rejectValue("username", "user.invalid", "No such username exists!");
            model.addAttribute("title", "Log In");
            return "login";
        }
